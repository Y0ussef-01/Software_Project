...
router.get(
  ...
  studentAuth,
  controller.getPendingSwapRequests,
);
...
router.get(
  "/analytics/:courseId",
  studentAuth,
  controller.getStudentCourseAnalytics,
);
router.post("/submit-complaint", studentAuth, controller.submitComplaint);
router.get("/myComplaints", studentAuth, controller.getMyComplaints);
