...
const Array1 = [
  ...
  { text: "Students", icon: <SchoolOutlinedIcon />, path: "/team" },
  { text: "Teachers", icon: <PeopleOutlineIcon />, path: "/teachers" },
  {
    text: "Enrollments",
...
const Array3 = [
  ...
  { text: "Geography Chart", icon: <PublicOutlinedIcon />, path: "/geography" },
];
